...
class Astar:
    ...
    def pathfinder(self):
        ...
        while self.o:                                                   # WHile there are items in the open list
            x = self.o.pop()                                         # Pop the best item from open list
            if x in self.c: continue                                    # If node is in the closed list, continue
            self.c.append(x)                                          # Push the node to the closed list
            ...
            for v in n:                                                 # Itterate neigbors
                ...
                l = list(self.o)
                if v not in self.o or g < l[l.index(v)].g:    # If not in open list or v has better cost from this node
                    v.g = g                                 
